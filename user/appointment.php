...
<body>
    ...
    $sqlmain.="order by appointment.appodate  asc"; //SELECT * FROM appointment
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            $mode=$row["Mode_of_consultation"]; //error here
                                            $status=$row["Status"];
                                            if($scheduleid==""){
                                                break;
                                            }
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>Appointment is successfully created.</h2>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            MH Specialist name&nbsp; : <b>'.substr($docname,0,40).'</b><br><br>
