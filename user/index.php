                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            Track your past and future appointments history here = 
                                <a href="doctors.php" class="non-style-link"><b>"All Mental Health Specialists"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                <!--<br>Also find out the expected arrival time of your medical consultant.<br><br>-->
                            </p>
                            
                            <h3>Channel a mental health specialist here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search mental health specialist and we will find the any sesssion available" list="doctors" style="width:45%;">&nbsp;&nbsp;
