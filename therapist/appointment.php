        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment  menu-active menu-icon-appoinment-active">
                        <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text"style="font-weight:bold;">My Appointments</p></a></div>
                    </td>
                </tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-notebook">
                        <a href="journal.php" class="non-style-link-menu"><div><p class="menu-text"style="font-weight:bold;">Journal Entries</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <?php
                    ...
                    $sqlmain= "select appointment.appoid,schedule.scheduleid,Mode_of_consultation,Status, schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  doctor.docid=$userid ";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       <a href="?action=approved&id='.$appoid.' &name='.$pname.'&session='.$title.'&apponum='.$apponum.' &Status='.$status.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Approve</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                            You want to approved this appointment<br><br>
                            Patient Name: &nbsp;<b>'.substr($nameget,0,40).'</b><br>
                            Appointment number &nbsp; : <b>'.substr($apponum,0,40).'</b><br><br>
                            Status &nbsp; : <b>'.substr($status,0,40).'</b><br><br>
