            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-view menu-active menu-icon-view-active">
                        <a href="add-appt.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text" style="font-weight:bold;">Add Session</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="add-appt.php">&times;</a> 
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Patients that already set an appointments for this session:</b> ('.$result12->num_rows."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>
